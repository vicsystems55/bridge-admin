...
<body
    ...
    <div role="article" aria-roledescription="email" aria-label="Welcome to Bridge 👋" lang="en"
                        ...
                        <tr>
                            <td class="sm-py-32 sm-px-24"
                                ...
                                <a href="https://bridgeafricaapp.com"
                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                                    <img src="{{ asset('/') }}images/loo.png" width="155" alt="logo"
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                We are please to
                                                welcome you to A 4-day annual national workshop on public finance management and leadership strategy for rectors, provosts, and bursars of polytechnics, colleges of technology, education, health, and agriculture in Nigeria.
                                            </p>

                                            <p
                                            style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-top: 24px; margin-bottom: 24px;">

                                            Your code is : {{$datax['id'] * 0.234}}
                                        </p>
                          ...
                          <li>
                            ...
                            specific SCSS, JS file. 🤟🏻
                                            ...
                                            <table cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td
                                                        style="mso-line-height-rule: exactly; mso-padding-alt: 16px 24px; border-radius: 4px; background-color: #151546; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                                        {{-- <a href="https://play.google.com/store/apps"
                                                            style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: block; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px; font-size: 16px; font-weight: 600; line-height: 100%; color: #ffffff; text-decoration: none;">Proceed
                                                            to Dashboard &rarr;</a> --}}
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <p
                                                ...
                                                <a href="mailto:support@example.com" class="hover-underline"
                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #151546; text-decoration: none;">let
                                                    us know</a>.
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">
                                                Thanks, <br>The Bursconn Team</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <p align="center"
                                                ...
                                                <a href="https://www.facebook.com/bridgeafricaapp"
                                                ...
                                                &bull;
                                                <a href="https://twitter.com/bridgeafricaapp"
                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238; text-decoration: none;"><img
                                                        src="{{ asset('/') }}images/twitter.png" width="17"
                                                        alt="Twitter"
                                                        style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0; margin-right: 12px;"></a>
                                                &bull;
                                                <a href="https://www.instagram.com/bridgeafricaapp"
                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238; text-decoration: none;"><img
                                            ...
                                            <p
                                                ...
                                                <a href="https://bridge.erp-55.com.ng/" class="hover-underline"
                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #151546; text-decoration: none;">Terms
                                                    of Use</a> and
                                                <a href="https://bridge.erp-55.com.ng/" class="hover-underline"
                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #151546; text-decoration: none;">Privacy
                                                    Policy</a>.
                                            </p>
                                        </td>
                                    </tr>
